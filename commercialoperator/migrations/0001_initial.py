# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-10-16 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='proposals', to='commercialoperator.Organisation')),
                ('application_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commercialoperator.ApplicationType')),
                ('approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='commercialoperator.Approval')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(blank=True, max_length=256, null=True)),
                ('name', models.CharField(choices=[('T Class', 'T Class')], default='T Class', max_length=64, verbose_name='Application name (eg. T Class, Filming, Event)')),
                ('schema', django.contrib.postgres.fields.jsonb.JSONField()),
                ('version', models.SmallIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referrals', to='commercialoperator.Proposal')),
                ('referral', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commercialoperator_referalls', to=settings.AUTH_USER_MODEL)),
                ('sent_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commercialoperator_assessor_referrals', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-lodged_on',),
            },
        ...
        migrations.AddField(
            model_name='proposalrequest',
            name='proposal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commercialoperator.Proposal'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='approval',
            name='applicant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='commercialoperator_approvals', to='commercialoperator.Organisation'),
        ),
        migrations.AddField(
            model_name='approval',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='commercialoperator.Proposal'),
        ),
        migrations.AddField(
            model_name='approval',
