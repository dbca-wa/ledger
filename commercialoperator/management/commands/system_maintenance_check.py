...
class Command(BaseCommand):
    ...
    Excecuted from cron, eg:
        ...
        * * * * * root cd /var/www/commercialoperator-dev2 && source venv/bin/activate && python manage_ds.py system_maintenance_check >/dev/null 2>&1

    CMD's eg:
        SUPERVISOR_STOP_CMD="supervisorctl stop commercialoperator-dev"
