                    ...
                    },
                    {
                        ...
                        mRender:function (data,type,full) {
                            ...
                            if (full.payment_status.toLowerCase()=='paid' || full.payment_method.toUpperCase()=='BPAY' || (full.payment_method.toLowerCase()=='monthly invoicing' && full.invoice_reference !== null)){
                                ...
                                links +=  `<a href='/cols/payments/monthly-confirmation-pdf/park-booking/${full.id}' target='_blank' style='padding-left: 52px;'><i style='color:red;' class='fa fa-file-pdf-o'></i></a><br/>`;
                            } 
                            return links;
                        },
                        name: '',
