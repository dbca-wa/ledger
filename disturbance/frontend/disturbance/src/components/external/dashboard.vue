        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="well well-sm">
                    <p>
                        Welcome to the Values Impact Assessment online system dashboard.<br/><br/>
                        Here you can access your existing approvals, view any proposals in progress, lodge new<br/>
