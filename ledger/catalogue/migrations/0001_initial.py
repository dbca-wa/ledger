    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_group', models.ForeignKey(null=True, verbose_name='Option Group', help_text='Select an option group if using type "Option"', to='catalogue.AttributeOptionGroup', blank=True,  on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(verbose_name='Attribute', to='catalogue.ProductAttribute' , on_delete=django.db.models.deletion.DO_NOTHING)),
                ('entity_content_type', models.ForeignKey(null=True, editable=False, to='contenttypes.ContentType', blank=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('product', models.ForeignKey(verbose_name='Product', related_name='attribute_values', to='catalogue.Product' , on_delete=django.db.models.deletion.DO_NOTHING)),
                ('value_option', models.ForeignKey(null=True, verbose_name='Value option', to='catalogue.AttributeOption', blank=True , on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(verbose_name='Category', to='catalogue.Category' , on_delete=django.db.models.deletion.DO_NOTHING)),
                ('product', models.ForeignKey(verbose_name='Product', to='catalogue.Product' , on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date created')),
                ('product', models.ForeignKey(verbose_name='Product', related_name='images', to='catalogue.Product' , on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary', models.ForeignKey(verbose_name='Primary product', related_name='primary_recommendations', to='catalogue.Product' , on_delete=django.db.models.deletion.DO_NOTHING)),
                ('recommendation', models.ForeignKey(verbose_name='Recommended product', to='catalogue.Product' , on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='product_class',
            field=models.ForeignKey(null=True, verbose_name='Product type', related_name='attributes', to='catalogue.ProductClass', blank=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(verbose_name='Group', related_name='options', to='catalogue.AttributeOptionGroup', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
    ]
