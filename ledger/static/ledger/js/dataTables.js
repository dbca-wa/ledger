...
!(function (n) {
    ...
    function mt(t, e, n, a) {
        ...
        function o(t) {
            (void 0 !== n && n !== d) ||
                ((l = f[d]), (s = t.innerHTML.trim()), l && l._bAttrSrc ? (m(l.mData._)(a, s), r(l.mData.sort, t), r(l.mData.type, t), r(l.mData.filter, t)) : h ? (l._setter || (l._setter = m(l.mData)), l._setter(a, s)) : (a[d] = s)),
                d++;
        }
        var i,
            l,
    ...
    function zt(t, e, n) {
        ...
        for (
            ...
            for (var D = $.ext.type.order[b.sType + "-pre"], x = m.aoData, S = 0; S < x.length; S++)
                x[S] && ((p = x[S])._aSortData || (p._aSortData = []), (p._aSortData[v] && !y) || ((g = y ? h[S] : G(m, S, v, "sort")), (p._aSortData[v] = D ? D(g, m) : g)));
        }
            ...
            e("row().data()", function (t) {
                ...
                return void 0 === t
                    ? n.length && this.length && this[0].length
                        ...
                        : void 0
                    : (((e = n[0].aoData[this[0]])._aData = t), Array.isArray(t) && e.nTr && e.nTr.id && m(n[0].rowId)(t, e.nTr.id), gt(n[0], this[0], "data"), this);
            }),
            e("row().node()", function () {
                var t = this.context;
            ...
            (e(be, function (t, e) {
                ...
                return void 0 === t
                    ? n.length && this.length && n[0].aoData[this[0]]
                        ...
                        : void 0
                    : (!0 === t ? this.child.show() : !1 === t ? me(this) : n.length && this.length && se(n[0], n[0].aoData[this[0]], t, e), this);
            }),
