...
urlpatterns = [
    ...
    re_path(r'^private-media/view/(?P<file_id>\d+)-(\w+).(?P<extension>\w\w\w\w)$', views.getAppFile, name='view_private_ledger_file2'),    
    re_path(r'^taxonomy/', include('ledger.taxonomy.urls')),
