...
def home(request):
    return render(request, 'passwordless/home.html')


def done(request):
    return render(request, 'passwordless/done.html')


def login_form(request):
    return render(request, 'passwordless/form.html')


def validation_sent(request):
    return render(request, 'passwordless/validation_sent.html', {
