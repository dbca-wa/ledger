...
class Order(CoreAbstractOrder):
    ...
    organisation = models.ForeignKey(Organisation, null=True,blank=True, related_name='order_organisation', on_delete=models.DO_NOTHING)
    #test = models.CharField("Test",max_length=50,null=True,blank=True)
