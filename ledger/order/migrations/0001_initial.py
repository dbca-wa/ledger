    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.ForeignKey(verbose_name='Event Type', to='customer.CommunicationEventType', on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.ForeignKey(verbose_name='Line', related_name='attributes', to='order.Line', on_delete=django.db.models.deletion.DO_NOTHING)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.ForeignKey(verbose_name='Line', related_name='prices', to='order.Line', on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
                'ordering': ('id',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(verbose_name='Order', related_name='discounts', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(verbose_name='Order', related_name='notes', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING)),
                ('user', models.ForeignKey(verbose_name='User', to=settings.AUTH_USER_MODEL, null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(verbose_name='Event', related_name='line_quantities', to='order.PaymentEvent', on_delete=django.db.models.deletion.DO_NOTHING)),
                ('line', models.ForeignKey(verbose_name='Line', related_name='payment_event_quantities', to='order.Line', on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(verbose_name='Quantity')),
                ('event', models.ForeignKey(verbose_name='Event', related_name='line_quantities', to='order.ShippingEvent', on_delete=django.db.models.deletion.DO_NOTHING)),
                ('line', models.ForeignKey(verbose_name='Line', related_name='shipping_event_quantities', to='order.Line', on_delete=django.db.models.deletion.DO_NOTHING)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='event_type',
            field=models.ForeignKey(verbose_name='Event Type', to='order.ShippingEventType', on_delete=django.db.models.deletion.DO_NOTHING),
        ...
        migrations.AddField(
            model_name='shippingevent',
            name='order',
            field=models.ForeignKey(verbose_name='Order', related_name='shipping_events', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='paymenteventquantity',
        ...
        migrations.AddField(
            ...
            name='event_type',
            field=models.ForeignKey(verbose_name='Event Type', to='order.PaymentEventType', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='paymentevent',
        ...
        migrations.AddField(
            model_name='paymentevent',
            name='order',
            field=models.ForeignKey(verbose_name='Order', related_name='payment_events', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='paymentevent',
            name='shipping_event',
            field=models.ForeignKey(related_name='payment_events', to='order.ShippingEvent', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(verbose_name='Option', related_name='line_prices', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='line',
            name='order',
            field=models.ForeignKey(verbose_name='Order', related_name='lines', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='line',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(verbose_name='Order', related_name='communication_events', to='order.Order', on_delete=django.db.models.deletion.DO_NOTHING),
            preserve_default=True,
        ),
    ]
