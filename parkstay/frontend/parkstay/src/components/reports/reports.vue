    ...
    methods:{
        ...
        generateValues:function () {
            ...
            if(vm.form.valid()){
                var values = {
                    "system":"S019",
                    "start":(vm.region) ? vm.flatDateStartPicker.data("DateTimePicker").date().set({hour:23,minute:59,second:59,millisecond:0}).format('YYYY-MM-DD H:mm:ss'):vm.accountsDateStartPicker.data("DateTimePicker").date().set({hour:23,minute:59,second:59,millisecond:0}).format('YYYY-MM-DD H:mm:ss'),
                    ...
                    "banked_start":vm.flatDateStartPicker.data("DateTimePicker").date().set({hour:23,minute:59,second:59,millisecond:0}).format('YYYY-MM-DD H:mm:ss'),
