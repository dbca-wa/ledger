...
from .models import Park, Campground, Campsite, CampgroundFeature, Region, CampsiteClass, CampsiteFeature, CampsiteBooking, Booking
...
admin.site.register(CampsiteFeature)
