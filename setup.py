...
setup(name='ledger',
      ...
      packages=['ledger','ledger.accounts','ledger.accounts.management','ledger.accounts.management.commands','ledger.accounts.migrations','ledger.accounts.templates',
                ...
                'ledger.payments','ledger.payments.bpay','ledger.payments.bpoint','ledger.payments.cash','ledger.payments.invoice','ledger.payments.management','ledger.payments.migrations','ledger.payments.static.payments','ledger.payments.dpaw_payments','ledger.payments.templatetags',
                ...
                'ledger.payments.invoice.management.commands',
                'ledger.payments.static.payments.img','ledger.payments.static.payments.js',
                'ledger.payments.static.payments.dpaw_payments','ledger.payments.static.payments.bpay','ledger.payments.static.payments.bpay','ledger.payments.static.payments.bpoint','ledger.payments.static.payments.emails','ledger.payments.static.payments.invoice',
