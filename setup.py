...
setup(name='ledger',
      ...
      packages=['ledger','ledger.accounts','ledger.accounts.management','ledger.accounts.management.commands','ledger.accounts.migrations','ledger.accounts.templates',
                ...
                'ledger.payments.static.payments.bpay','ledger.payments.static.payments.bpay','ledger.payments.static.payments.bpoint','ledger.payments.static.payments.emails','ledger.payments.static.payments.invoice',
