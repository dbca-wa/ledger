...
export default {
    ...
    data: function() {
        ...
        return {
            ...
            msh_options: {
                ...
                ajax: {
                    url: api_endpoints.campsiteStayHistory(vm.object_id),
                    dataSrc: ''
                },
                columns: [{
                    "data": "id"
    ...
    methods: {
        ...
        addStayHistory: function() {
            this.sendData(api_endpoints.campsites_stay_history, 'POST')
        },
        updateStayHistory: function() {
            this.sendData(api_endpoints.campsites_stay_history_detail(this.stay.id),'PUT');
        },
