...
router.register(r'campground_map', api.MooringAreaMapViewSet)
router.register(r'campground_map_filter', api.MooringAreaMapFilterViewSet)
...
router.register(r'campgrounds', api.MooringAreaViewSet)
router.register(r'campsites', api.MooringsiteViewSet)
router.register(r'campsite_bookings', api.MooringsiteBookingViewSet)
...
router.register(r'campsite_classes',api.MooringsiteClassViewSet)
router.register(r'booking',api.BookingViewSet)
router.register(r'campground_booking_ranges',api.MooringAreaBookingRangeViewset)
router.register(r'campsite_booking_ranges',api.MooringsiteBookingRangeViewset)
router.register(r'campsite_rate',api.MooringsiteRateViewSet)
router.register(r'campsites_stay_history',api.MooringsiteStayHistoryViewSet)
router.register(r'campground_stay_history',api.MooringAreaStayHistoryViewSet)
...
urlpatterns = [
    ...
    url(r'^campsites/(?P<ground_id>[0-9]+)/$', views.MooringsiteBookingSelector.as_view(), name='campsite_booking_selector'),
