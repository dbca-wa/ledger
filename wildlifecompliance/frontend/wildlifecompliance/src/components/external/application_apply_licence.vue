                                                    ...
                                                    <div v-if="!(behalf_of_org != '' && type.not_for_organisation == true)" v-for="(type,index1) in category.activity_type" class="checkbox margin-left-20">
                                                        ...
                                                        <div v-if="type.selected">
                                                            <div v-for="(activity,index2) in type.activity" class="checkbox activity-clear-left">
                                                                ...
                                                                <div class ="col-sm-12">
                                                                    <input type="checkbox" :value="activity.id" :id="activity.id" v-model="type.activity[index2].selected" @click="handleActivityCheckboxChange(index,index1,index2,$event)">{{activity.name}}<span> ({{activity.base_application_fee}} + {{activity.base_licence_fee}})</span>
                                                                </div>
