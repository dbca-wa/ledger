...
class MultiImage(AbstractPromotion):
    ...
    class Meta:
        app_label = 'mulitimage_promotions'
...
class SingleProduct(AbstractPromotion):
    ...
    class Meta:
        app_label = 'singleproduct_promotions'
...
class AbstractProductList(AbstractPromotion):
    ...
    class Meta:
        abstract = True
        app_label = 'abstractproductlist_promotions'
...
class HandPickedProductList(AbstractProductList):
    ...
    class Meta:
        app_label = 'handpickedproductlist_promotions'
...
class OrderedProduct(models.Model):
    ...
    class Meta:
        app_label = 'orderedproduct_promotions'
...
class AutomaticProductList(AbstractProductList):
    ...
    class Meta:
        app_label = 'automaticproductlist_promotions'
...
class OrderedProductList(HandPickedProductList):
    ...
    class Meta:
        app_label = 'orderedproductlist_promotions'
        ordering = ('display_order',)
...
class TabbedBlock(AbstractPromotion):
    ...
    class Meta:
        app_label = 'tabbedblocked_promotions'
        verbose_name = _("Tabbed Block")
